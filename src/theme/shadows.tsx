...
// Define types for the shadow functions
type ShadowColor = string;
type ShadowArray = string[];
type CustomShadow = {
  z1: string;
  z8: string;
  z12: string;
...
const LIGHT_MODE = palette.light.gray[500];
const DARK_MODE = '#000000';

// Create a shadow function
const createShadow = (color: ShadowColor): ShadowArray => {
...
const createCustomShadow = (color: ShadowColor): CustomShadow => {
